...
const Admin = () => {
    ...
    const handleAddOrUpdate = async (e) => {
        ...
        try {
            if (isEditing) {
                // Update item
                await axios.put(`https://food-delivery-website-6y8r.onrender.com/api/menus/menu/${formState.id}`, formData, {
                    headers: {
                ...
                // Add new item
                await axios.post("https://food-delivery-website-6y8r.onrender.com/api/menus/menu", formData, {
                    headers: {
                        "Content-Type": "multipart/form-data", // Set the content type for file uploads
                    },
                });
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://food-delivery-website-6y8r.onrender.com/api/menus/menu/${id}`);
            fetchMenuItems();
        } catch (error) {
