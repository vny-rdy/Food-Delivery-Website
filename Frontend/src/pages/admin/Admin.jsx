...
const Admin = () => {
    ...
    const fetchMenuItems = async () => {
        try {
            const response = await axios.get("https://food-delivery-website-i79e.onrender.com/api/menus/menu");
    ...
    const handleAddOrUpdate = async (e) => {
        ...
        try {
            if (isEditing) {
                // Update item
                await axios.put(`https://food-delivery-website-i79e.onrender.com/api/menus/menu/${formState.id}`, formData, {
                    headers: {
                ...
                // Add new item
                await axios.post("https://food-delivery-website-i79e.onrender.com/api/menus/menu", formData, {
                    headers: {
                        "Content-Type": "multipart/form-data", // Set the content type for file uploads
                    },
                });
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://food-delivery-website-i79e.onrender.com/api/menus/menu/${id}`);
            fetchMenuItems();
        } catch (error) {
