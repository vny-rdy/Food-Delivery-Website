...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        const fetchCartItems = async () => {
            try {
                const response = await axios.get(`https://food-delivery-website-i79e.onrender.com/api/cart/${user}`);
    ...
    const handleRemoveItem = async (itemId) => {
        try {
            const response = await axios.post(`https://food-delivery-website-i79e.onrender.com/api/cart/removeItem`, { user, itemId });
