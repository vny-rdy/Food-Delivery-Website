...
const Signup = () => {
  ...
  const handleSendOtp = async () => {
    try {
      const response = await axios.post("https://food-delivery-website-i79e.onrender.com/api/auth/send-otp", { phone });
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await axios.post("https://food-delivery-website-i79e.onrender.com/api/auth/verify-otp", { phone, otp });
      if (response.data.success) {
  ...
  const handleSetPassword = async () => {
    ...
    try {
      const response = await axios.post("https://food-delivery-website-i79e.onrender.com/api/auth/set-username", { phone, username, password });
      if (response.data.success) {
