...
const Menu = () => {
    ...
    const handleAddToCart = async (item) => {
        if (!user) {
            ...
            try {
                await axios.post("https://food-delivery-website-i79e.onrender.com/api/cart/addToCart", cartItem);
    ...
    const confirmOrder = async () => {
        ...
        try {
            await axios.post("https://food-delivery-website-i79e.onrender.com/api/order/confirmOrder", orderData);
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
                    {filteredItems.map((item) => (
                        <div key={item._id} className="border p-4 rounded shadow">
                            <img
                                src={`https://food-delivery-website-i79e.onrender.com/${item.image}`}
                                alt={item.name}
