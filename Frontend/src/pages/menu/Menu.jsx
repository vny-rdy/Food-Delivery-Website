...
const Menu = () => {
    ...
    const handleAddToCart = async (item) => {
        if (!user) {
            ...
            try {
                await axios.post("https://food-delivery-website-sepia-tau.vercel.app/api/cart/addToCart", cartItem);
    ...
    const confirmOrder = async () => {
        ...
        try {
            await axios.post("https://food-delivery-website-sepia-tau.vercel.app/api/order/confirmOrder", orderData);
